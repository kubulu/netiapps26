    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            const Line = ($el: Element) => {
                ...
                const duration = gsap.utils.random(60, 100); // Slower movement
                const y = gsap.utils.random(-150, 150); // Reduced range to keep closer to middle
                const rotate = gsap.utils.random(-10, 10); // Reduced rotation flexibility
            ...
            gsap.utils.toArray(".g").forEach(($el) => Line($el as Element));
                ...
                <g>
                    {Array.from({ length: 8 }).map((_, i) => (
                        <g key={i} className="g">
                            <path
                                className="path"
                                fill={["#FF5733", "#33FF57", "#3357FF", "#F033FF", "#FF33A8", "#33FFF5", "#FF8C33", "#8C33FF"][i % 8]}
                                fillOpacity="0.6"
